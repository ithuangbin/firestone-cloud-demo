...
import com.firestone.enums.ResultEnum;
...
public class ServerResult<T> {
    ...
    public static <T>ServerResult<T> timeout(){
        ServerResult<T> result = new ServerResult<T>();
        result.setCode(ResultEnum.TIME_OUT.getCode());
        result.setMsg(ResultEnum.TIME_OUT.getMsg());
        return result;
    }
}
